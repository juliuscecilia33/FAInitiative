...
const Sidebar: React.FC = () => (
  <div className="fixed flex flex-col items-center content-between h-full py-5 border-r border-primary w-1/18">
    <div className="fixed flex flex-col items-center justify-center">
      <div className="flex items-center justify-center w-12 h-12 mb-12 rounded-full cursor-pointer bg-secondary">
